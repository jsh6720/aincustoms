...
where account_category is null
   or account_category not in ('shipper', 'destination', 'samhyeon');
...
declare
  ...
  v_account_category text := case
    ...
    when p_account_category = 'samhyeon' then 'samhyeon'
    else 'shipper'
  end;
begin
...
begin
  ...
  where lower(login_id) = lower('shyun')
  ...
  if v_account_id is null then
    ...
    values (
      'shyun',
      '$2a$12$ukp5YqL0hNT3KEYTUbzIPeKJ4uyvUxdbLreu1/qKn9haN9GqS1dmC',
      '삼현',
      '현대코',
      'shipper',
      'samhyeon',
    ...
    update public.shipper_accounts
    set login_id = 'shyun',
        password_hash = '$2a$12$ukp5YqL0hNT3KEYTUbzIPeKJ4uyvUxdbLreu1/qKn9haN9GqS1dmC',
        display_name = '삼현',
